...
\fancyhead[L]{\includegraphics[height=6mm]{GTA_logo}} % Dateiendung weglassen, nutzt PDF wenn vorhanden
\fancyfoot[R]{\thepage}
...
\titleformat{\section}
  {\Large\bfseries\color{black}\raggedright}{\thesection}{0.75em}{}
...
\newcommand{\logorow}{%
  ...
  \begin{minipage}[c]{0.3\textwidth}
    \centering
    \includegraphics[width=0.9\linewidth, keepaspectratio]{GTA_logo}
  \end{minipage}%
  \hfill
  \begin{minipage}[c]{0.35\textwidth}
    \centering
    \includegraphics[width=1.1\linewidth, keepaspectratio]{SECO_logo}
  \end{minipage}%
  \hfill
  \begin{minipage}[c]{0.3\textwidth}
    \centering
    \includegraphics[width=0.8\linewidth, keepaspectratio]{C4TP_logo}
  \end{minipage}%
}
